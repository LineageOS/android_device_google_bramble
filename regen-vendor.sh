...
VENDOR_SKIP_FILES=(
    ...
    "bin/hw/android.hardware.usb@1.3-service.bramble"
    ...
    "etc/init/android.hardware.usb@1.3-service.bramble.rc"
    ...
    "etc/vintf/manifest/android.hardware.usb@1.3-service.bramble.xml"
