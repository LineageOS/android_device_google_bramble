...
VENDOR_SKIP_FILES_REDBULL=(
    ...
    "bin/hw/android.hardware.usb@1.2-service.bramble"
    ...
    "etc/init/android.hardware.usb@1.2-service.bramble.rc"
    ...
    "etc/vintf/manifest/android.hardware.usb@1.2-service.bramble.xml"
